                                ...
                                <div class="card-body card-dashboard">
                                    <table style="width: 100%"
                                        ...
                                        <?php
                                            ...
                                            $query="SELECT * FROM logina,onlinet WHERE id = id_on";
                                            $result=mysqli_query($connection,$query);
                                            $row=mysqli_fetch_assoc($result);
                                                    echo "<tr>" . "<td>" . $row["name"] . "</td>" . "<td>" . $row["email"] . "</td>"
                                                    . "<td>" . $row["password"] . "</td>"
                                                    
                                                    . "<td>  <a href='editProfile.php?id=".$row["id"]."' class='btn btn-outline-primary  box-shadow-3 mr-1 mb-1'><i
                                                    class='icon-eye'></i></a>
                                                 </td>"
                                                 
                                                 . "<td>  <form action='deleteProfile.php' class='form-delete' method='post'>
